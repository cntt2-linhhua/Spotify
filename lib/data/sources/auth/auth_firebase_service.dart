...
import 'package:shopify/data/models/auth/user.dart';
...
class AuthFirebaseServiceImp extends AuthFirebaseService {
  ...
  Future<Either> getUser() async {
    try {
      ...
      UserModel userModel = UserModel.fromJon(user.data()!);
      userModel.imageURL = firebaseAuth.currentUser?.photoURL ?? AppUrls.defaultUser;
